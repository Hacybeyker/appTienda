 ...
 */
public class FormGestionarTipoDeProducto extends javax.swing.JDialog {

    
    ArrayList<TipoProducto> listaTipoDeProducto;
    Tabla tabla; 
    ModeloTabla modeloTablaTipoProducto;
    /**
     * Creates new form FormGestionarTipoDeProducto
     * @param parent
     * @param modal
     */
    public FormGestionarTipoDeProducto(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
        setResizable(false);
        crearTabla();
    ...
    private void initComponents() {
        ...
        tablaTipodeProducto = new javax.swing.JTable();
        ...
        tablaTipodeProducto.setAutoCreateRowSorter(true);
        tablaTipodeProducto.setModel(new javax.swing.table.DefaultTableModel(
            new Object [][] {
        ...
        jScrollPane1.setViewportView(tablaTipodeProducto);
    ...
    private void botonModificarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_botonModificarActionPerformed
        ...
        try {
            TipoProducto tipoProducto = gestionarTipoProductoServicio.buscar(tipoProductoid);
            if(tipoProducto != null){
                FormRegistrarTipoDeProducto formRegistrarTipoDeProducto = new FormRegistrarTipoDeProducto(this, tipoProducto);
                formRegistrarTipoDeProducto.setVisible(true);
            }
            else{
    ...
    private void botonEliminarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_botonEliminarActionPerformed
        ...
        GestionarTipoProductoServicio gestionarTipoProductoServicio = new GestionarTipoProductoServicio();                    
        try {
            int registros_afectados = gestionarTipoProductoServicio.eliminar(obtenerCodigoDeLaTabla());
    ...
    private void consultarTipoDeProducto() {
        ...
        try {
            GestionarTipoProductoServicio gestionarTipoProductoServicio = new GestionarTipoProductoServicio();
            listaTipoDeProducto = gestionarTipoProductoServicio.buscarPorNombre(nombre);
            if(listaTipoDeProducto!=null && listaTipoDeProducto.size()>0){
                ...
                tablaTipodeProducto.setModel(modeloTablaTipoProducto);
            }else{
    ...
    private void crearTabla() {
        ...
        modeloTablaTipoProducto  = new ModeloTabla(tabla);
        tablaTipodeProducto.setModel(modeloTablaTipoProducto);
        //CODIGO
        TableColumn columna0,columna1,columna2;
        columna0 = tablaTipodeProducto.getColumnModel().getColumn(0);
        columna0.setPreferredWidth(100);
        columna0.setMaxWidth(100);
        columna0.setMinWidth(100);
        //NOMBRE
        columna1 = tablaTipodeProducto.getColumnModel().getColumn(1);
        columna1.setPreferredWidth(150);
        columna1.setMaxWidth(150);
        columna1.setMinWidth(150);
        //DESCRIPCION
        columna2 = tablaTipodeProducto.getColumnModel().getColumn(2);
        columna2.setPreferredWidth(300);
        columna2.setMaxWidth(300);
        columna2.setMinWidth(300);
        
        tablaTipodeProducto.removeColumn(columna0);
    }
    
    private int obtenerCodigoDeLaTabla() {
        int numFila = tablaTipodeProducto.getSelectedRow();
        if(numFila == -1){
            Mensaje.Mostrar_MENSAJE_FILANOSELECCIONADO(this);
            return 0;
        }
        modeloTablaTipoProducto = (ModeloTabla) tablaTipodeProducto.getModel();
        return (Integer)modeloTablaTipoProducto.getValueAt(numFila, 0); // se retorna el id de la fila seleccionada
    }
    ...
    private javax.swing.JTable tablaTipodeProducto;
