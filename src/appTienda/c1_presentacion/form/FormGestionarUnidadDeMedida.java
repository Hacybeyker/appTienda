...
public class FormGestionarUnidadDeMedida extends javax.swing.JDialog {
    ...
    Tabla tabla;
    ModeloTabla modeloTablaUnidadDeMedida;
    /**
     * Creates new form FormGestionarUnidadDeMedida
     * @param parent
     * @param modal
     */
    public FormGestionarUnidadDeMedida(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
        setResizable(false);
        crearTabla();
    ...
    private void initComponents() {
        ...
        tablaUnidadDeMedida = new javax.swing.JTable();
        ...
        tablaUnidadDeMedida.setAutoCreateRowSorter(true);
        tablaUnidadDeMedida.setModel(new javax.swing.table.DefaultTableModel(
            new Object [][] {
        ...
        jScrollPane1.setViewportView(tablaUnidadDeMedida);
    ...
    private void botonModificarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_botonModificarActionPerformed
        // TODO add your handling code here:
        int unidadDeMedidaid = obtenerCodigoDeLaTabla();
        if(unidadDeMedidaid == 0)
            return;
        GestionarUnidadDeMedidaServicio gestionarUnidadDeMedidaServicio = new GestionarUnidadDeMedidaServicio();    
        try {
            UnidadDeMedida unidadDeMedida = gestionarUnidadDeMedidaServicio.buscar(unidadDeMedidaid);
            if(unidadDeMedida != null){
                FormRegistrarUnidadDeMedida formRegistrarUnidadDeMedida = new FormRegistrarUnidadDeMedida(this, unidadDeMedida);
                formRegistrarUnidadDeMedida.setVisible(true);
            }
            else{
    ...
    private void botonEliminarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_botonEliminarActionPerformed
        ...
        GestionarUnidadDeMedidaServicio gestionarUnidadDeMedidaServicio = new GestionarUnidadDeMedidaServicio();                    
        try {
            int registros_afectados = gestionarUnidadDeMedidaServicio.eliminar(obtenerCodigoDeLaTabla());
    ...
    private void consultarTipoDeProducto() {
        ...
        try {
            GestionarUnidadDeMedidaServicio gestionarUnidadDeMedidaServicio = new GestionarUnidadDeMedidaServicio();
            listaUnidadDeMedida = gestionarUnidadDeMedidaServicio.buscarPorNombre(nombre);
            if(listaUnidadDeMedida!=null && listaUnidadDeMedida.size()>0){
                for(UnidadDeMedida unidadDeMedida : listaUnidadDeMedida){
                    Fila fila = new Fila();
                    fila.agregarValorCelda(unidadDeMedida.getCodigo());
                    fila.agregarValorCelda(unidadDeMedida.getNombre());
                    fila.agregarValorCelda(unidadDeMedida.getDescripcion());
                    tabla.agregarFila(fila);
                }         
                tablaUnidadDeMedida.setModel(modeloTablaUnidadDeMedida);
            }else{
    ...
    private void crearTabla() {
        ...
        modeloTablaUnidadDeMedida  = new ModeloTabla(tabla);
        tablaUnidadDeMedida.setModel(modeloTablaUnidadDeMedida);
        //CODIGO
        TableColumn columna0,columna1,columna2;
        columna0 = tablaUnidadDeMedida.getColumnModel().getColumn(0);
        columna0.setPreferredWidth(100);
        columna0.setMaxWidth(100);
        columna0.setMinWidth(100);
        //NOMBRE
        columna1 = tablaUnidadDeMedida.getColumnModel().getColumn(1);
        columna1.setPreferredWidth(150);
        columna1.setMaxWidth(150);
        columna1.setMinWidth(150);
        //DESCRIPCION
        columna2 = tablaUnidadDeMedida.getColumnModel().getColumn(2);
        columna2.setPreferredWidth(300);
        columna2.setMaxWidth(300);
        columna2.setMinWidth(300);
        
        tablaUnidadDeMedida.removeColumn(columna0);
    }
    
    private int obtenerCodigoDeLaTabla() {
        int numFila = tablaUnidadDeMedida.getSelectedRow();
        if(numFila == -1){
            Mensaje.Mostrar_MENSAJE_FILANOSELECCIONADO(this);
            return 0;
        }
        modeloTablaUnidadDeMedida = (ModeloTabla) tablaUnidadDeMedida.getModel();
        return (Integer)modeloTablaUnidadDeMedida.getValueAt(numFila, 0); // se retorna el id de la fila seleccionada
    }
    ...
    private javax.swing.JTable tablaUnidadDeMedida;
